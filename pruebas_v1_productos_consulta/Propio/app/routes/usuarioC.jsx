    ...
    <div className="container">
      ...
      <div className="main">
        <div className="controles">
          <button className="ops-btn ops-btn--primary" onClick={abrirNuevoUsuario}>
            Nuevo Usuario
          </button>
              ...
              {usuariosFiltrados.length === 0 ? (
                ...
                usuariosFiltrados.map((u) => (
                  <tr key={u.id}>
                    ...
                    <td>
                      <button className="ops-btn ops-btn--ghost" onClick={() => editar(u)}>
                        Editar
                      </button>
                      <button className="ops-btn ops-btn--danger" onClick={() => eliminar(u.id)}>
                        Eliminar
                      </button>
                    </td>
                  </tr>
